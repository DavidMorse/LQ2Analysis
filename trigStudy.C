...
void zJetsComparison(){
  ...
  TCut amcElse = "(M_uu>100)*5000"; TCut amcElsePlusPre = amcElse*cuts[2]*MuuCut;
  TCut amc = "weight_amcNLO";
  TCut amcAll = "weight_amcNLO*5000*(M_uu>100)";
  TCut weightcut2 = "weight_central*5000.";TCut weightcut = weightcut2*MuuCut*cuts[2];TCut weightcutAMC = weightcut2*MuuCut*cuts[2]*amc;
 ...
 float xsecs[37]={60.6,20.3,8.04,3.59,1.74,.906,.496,.284,.169,.103,.0648,.0416,.0273,.0182,.0123,.00845,.00586,.00411,.00291,.00208,.00150,.00109,.000795,.000585,.000433,.000321,.000240,.000180,.000135,.000102,.0000774,.0000588,.0000448,.0000343,.0000262,.0000201,.0000155};
  ...
  for(int i=0;i<nFiles;i++){
    ...
    h_Muu[i] = new TH1F(muuNam,"M_{uu};M_{uu};Arbitrary Units",250,0,5000);
    h_Muujj1[i] = new TH1F(nam1,"M_{uujj1};M_{uujj1};Arbitrary Units",250,0,5000);
    h_Muujj2[i] = new TH1F(nam2,"M_{uujj2};M_{uujj2};Arbitrary Units",250,0,5000);
    h_PTu1[i] = new TH1F(ptnam1,"P_{T}(muon1);P_{T}(muon1);Arbitrary Units",250,0,5000);
    h_PTu2[i] = new TH1F(ptnam2,"P_{T}(muon2);P_{T}(muon2);Arbitrary Units",250,0,5000);
    h_PTj1[i] = new TH1F(ptjnam1,"P_{T}(jet1);P_{T}(jet1);Arbitrary Units",250,0,5000);
    h_PTj2[i] = new TH1F(ptjnam2,"P_{T}(jet2);P_{T}(jet2);Arbitrary Units",250,0,5000);
    h_STuujj[i] = new TH1F(stNam,"ST_{uujj};ST_{uujj};Arbitrary Units",250,0,10000);
  ...
  h_PTu1w = new TH1F("h_PTu1w","P_{T}(muon1)*weight_amcNLO;P_{T}(muon1);Events",250,0,5000);h_PTu1w->Sumw2();
  h_PTu1x = new TH1F("h_PTu1x","P_{T}(muon1);P_{T}(muon1);Events",250,0,5000);h_PTu1x->Sumw2();
  ...
  */
  ...
  leg.SetHeader("13 TeV (5 fb^{-1} ) DY+Jets sim., M_{ll}>100");
