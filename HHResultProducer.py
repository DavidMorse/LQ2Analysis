...
preselectionmumu = '((Pt_muon1>20)*(Pt_muon2>10)*(Pt_Hjet1>20)*(Pt_Hjet2>20)*(Pt_Zjet1>20)*(Pt_Zjet2>20)*(M_uu>10)*((Charge_muon1*Charge_muon2)<0)*(TrkIso_muon1<0.1)*(TrkIso_muon2<0.1))'
...
qcdselectionmumu = '((Pt_muon1>20)*(Pt_muon2>10)*(Pt_Hjet1>20)*(Pt_Hjet2>20)*(Pt_Zjet1>20)*(Pt_Zjet2>20)*(M_uu>12))' #Change to  M_uu > 10
...
#	print '\n'
	...
	HistList = [hs_os_iso,hs_os_noniso,hs_ss_iso,hs_ss_noniso]
...
def MakeBasicPlot(recovariable,xlabel,presentationbinning,selection,weight,FileDirectory,tagname,channel, zscale, wscale, ttscale,cutlog,version_name,plotmass):
	...
	hs_rec_TTBar=CreateHisto('hs_rec_TTBar','t#bar{t}',t_T,recovariable,presentationbinning,selection+'*('+str(ttscale)+')*'+weight,TTStackStyle,Label)
	...
	print 'hs_rec_SMHiggs.Integral = ',hs_rec_SMHiggs.Integral()
        QCDRegion = QCDStudy(recovariable,presentationbinning,qcdselectionmumu,weight,zscale,wscale,ttscale,version_name,Label)
	hs_rec_QCD = QCDRegion[4]
	...
	#style = [0,22,1.2,4,kBlue]
	#style2 = [0,22,1.2,4,kRed]
	#label = [xlabel,ylabel]


#	print "Plotting Region A"
	#Plot 4 Regions
#	c2 = TCanvas("c2","hists with different scales",600,400)
#	c2.SetLogy()
 #       QCDRegion[0].Draw()
#
#	print "Plotting Region B"
#	c3 = TCanvas("c2","hists with different scales",600,400)
#	c3.SetLogy()
 #       QCDRegion[1].Draw()
#
#	print "Plotting Region C"
#	c4 = TCanvas("c2","hists with different scales",600,400)
#	c4.SetLogy()
       # QCDRegion[2].Draw()


	#print "Plotting Region D"
	#c5 = TCanvas("c2","hists with different scales",600,400)
	#c5.SetLogy()
        #QCDRegion[3].Draw()


	#print "Plotting Region A with QCD estimate"
	#Comparison of QCD region A with Estimate 
	#c6 = TCanvas("c2","hists with different scales",600,400)
	#c6.SetLogy()
	#QCDRegion[0].Draw()
        #QCDRegion[4].Draw("same")
	...
	#c2.cd()
       # if 'final' not in tagname:
       #         c2.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+'_QCDRegionA'+'.pdf')
       # else:
#		c2.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+str(plotmass)+'_QCDRegionA'+'.pdf')

        #c3.cd()
#	if 'final' not in tagname:
#		c3.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+'_QCDRegionB'+'.pdf')
#        else:   #
	#	c3.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+str(plotmass)+'_QCDRegionB'+'.pdf')
	#c4.cd()
	#if 'final' not in tagname:
         #       c4.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+'_QCDRegionC'+'.pdf')
	#else:
	 #       c4.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+str(plotmass)+'_QCDRegionC'+'.pdf')
	#c5.cd()
	#if 'final' not in tagname:
         #       c5.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+'_QCDRegionD'+'.pdf')
	#else:
	 #       c5.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+str(plotmass)+'_QCDRegionD'+'.pdf')

	#c6.cd()
	#if 'final' not in tagname:
        #        c6.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+'_QCDComparison'+'.pdf')
	#else:
	 #       c6.Print('Results_'+version_name+'/BasicLQ_'+channel+'_'+recovariable+'_'+tagname+str(plotmass)+'_QCDComparison'+'.pdf')
