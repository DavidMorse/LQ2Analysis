...
FinalDatacard = 'Results_'+year+'/Final_selection/FinalCardsFinSelSysLQ_'+year+'.txt'
SysDatacard = 'Results_'+year+'/Enhanced_selection/FinalCardsLQ_'+year+'.txt'
...
with open('Results_'+year+'/Final_selection/FinalCardsLQ_'+year+'.txt','w') as outFile:
    for mass in masses:
