...
FinalDatacard = 'Results_'+year+'_muPt20/Final_selection/FinalCardsFinSelSysLQ_'+year+'.txt'
SysDatacard = 'Results_'+year+'_muPt20/Enhanced_selection/FinalCardsLQ_'+year+'.txt'
...
with open('Results_'+year+'_muPt20/Final_selection/FinalCardsLQ_'+year+'.txt','w') as outFile:
    for mass in masses:
