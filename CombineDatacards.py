...
FinalDatacard = 'Results_Testing_'+year+'_stockNanoAODv7_Run2CombBDT_FullSys_PDF/Optimization/FinalCardsFinSelSysLQ_'+year+'.txt'
SysDatacard = 'Results_Testing_'+year+'_stockNanoAODv7_Run2CombBDT_FullSys_PDF/Optimization_EnhancedPresel/FinalCardsLQ_'+year+'.txt'
...
with open('Results_Testing_'+year+'_stockNanoAODv7_Run2CombBDT_FullSys_PDF/Optimization/FinalCardsLQ_'+year+'.txt','w') as outFile:
    for mass in masses:
