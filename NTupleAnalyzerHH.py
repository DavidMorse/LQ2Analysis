...
def LooseIDJets(T,met,variation,isdata):
	...
	for n in range(len(_PFJetPt)):
		if _PFJetPt[n]>20 and abs(T.PFJetEtaAK4CHS[n])<2.4 :#fixme todo was pt>30, reduced for HH
...
#for n in range(20):
	...
	Branches['passBeamHalo2015'][0]           = 1
	Branches['passBadEcalSC'][0]              = 1
	Branches['passBadMuonTrackList'][0]       = 1
	Branches['passBadResTrackList'][0]        = 1
